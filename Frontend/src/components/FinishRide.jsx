...
const FinishRide = (props) => {
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-4 border-2 border-gonexi-accent rounded-lg mt-4 bg-gonexi-accent/10'>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-10 w-full'>
                    {props.ride?.paymentStatus !== 'paid' && (
                        <p className='rounded-lg bg-orange-50 px-4 py-3 text-sm text-orange-700'>
                    ...
                    <button
                        onClick={endRide}
                        className='w-full mt-5 flex text-lg justify-center bg-gonexi-gradient text-white font-semibold p-3 rounded-lg'
                    >
                        Finish Ride
                    </button>
                </div>
